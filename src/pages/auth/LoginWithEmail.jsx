    ...
    return (
        <div className="flex items-center justify-center py-5  px-6">
            <div className="w-full max-w-md p-8  text-black rounded-lg slideUp shadow-lg">
                ...
                <p className="text-center text-gray-600 text-sm mb-6">Enter your details to log in</p>
                ...
                <button className="mt-4 flex items-center justify-center w-full px-4 py-2 bg-gray-100 rounded-lg text-gray-700 shadow-sm text-sm font-medium hover:bg-gray-200" onClick={() => {
