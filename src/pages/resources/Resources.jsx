    ...
    <div className="p-6 overflow-x-auto">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          <button
            className="themebg text-white px-4 py-2 rounded hover:bg-blue-600"
      ...
      >
        <div className="mx-auto d-flex flex-row">
          {categories.map((category, index) => (
            <button
              key={index}
              className={`d-block transition small px-6 py-2 border border-gray-300 text-gray-700 ${
                category.toLowerCase() == theCategory.toLowerCase()
                  ? "bg-[#0f3d5f] text-white"
                  : "bg-white hover:bg-gray-200"
              } min-w-[${category.length * 50}px]`}
              onClick={() => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {resources.map((resource, index) =>
          theCategory.toLowerCase() == resource?.type?.toLowerCase() ? (
            <Delay delay={10 * index}>
              ...
              >
                <button
                  className="bg-red-700 m-2 ph-r text-white px-1 ms-auto py-2 rounded hover:bg-red-600"
